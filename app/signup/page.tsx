      ...
      <PageShell>
        <div className="min-h-screen flex flex-col items-center justify-center text-center pb-16">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm max-w-xs leading-relaxed mb-6">
            We&apos;ve sent a confirmation link to <strong className="text-gray-700 dark:text-gray-200">{email}</strong>.
            Click it to activate your account and start building your Kind Curve.
          </p>
    ...
    <PageShell>
      <div className="min-h-screen flex flex-col items-center justify-center pb-16">
        ...
        <div className="w-full space-y-4">
          ...
          <TealButton onClick={handleSignup} disabled={loading || !email || password.length < 6}>
