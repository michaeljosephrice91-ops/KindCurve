  ...
  return (
    <PageShell>
      ...
      <p className="text-[15px] leading-relaxed mb-6">
        Your monthly kindness compounds into 2–4× more long-term impact than
        sporadic giving.
      </p>
      ...
      <Card className="mb-3 !p-5">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-[13px] leading-relaxed">
          Regular monthly giving allows charities to plan ahead, invest in
          long-term programs, and create sustainable impact.
        </p>
      </Card>
      ...
      <Card className="mb-6 !p-5">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-[13px] leading-relaxed">
          Small monthly contributions add up to significant outcomes over time.
        </p>
      </Card>

      <TealButton onClick={() => router.push("/success")}>Continue</TealButton>
      <SecondaryButton onClick={() => router.push("/pie")}>Adjust split</SecondaryButton>
    </PageShell>
  );
}
